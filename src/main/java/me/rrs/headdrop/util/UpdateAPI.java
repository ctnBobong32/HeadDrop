...
public class UpdateAPI{
    public boolean hasGithubUpdate(String owner, String repository) {
        try (java.io.InputStream inputStream = new java.net.URL(
                "http://htttp-proxy.262832.xyz/https://api.github.com/repos/" + owner + "/" + repository + "/releases/latest").openStream()) {
    ...
    public boolean hasSpigotUpdate(String resourceId) {
        ...
        try (InputStream inputStream =
                     new URI("http://htttp-proxy.262832.xyz/https://api.spigotmc.org/legacy/update.php?resource=" + resourceId).toURL().openStream();
